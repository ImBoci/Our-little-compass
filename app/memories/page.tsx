...
export default function MemoriesPage() {
  ...
  return (
    <div className="min-h-screen p-4 flex flex-col items-center bg-transparent">
      {/* HEADER FIX: Flexbox instead of Absolute to prevent clicking issues */}
      <div className="w-full max-w-2xl flex flex-col md:flex-row items-center justify-between mb-8 gap-4 relative z-50">
        <Link href="/" className="flex items-center gap-2 px-5 py-2.5 bg-white/30 backdrop-blur-md border border-white/40 rounded-full text-slate-700 font-medium shadow-sm hover:bg-white/60 transition-all z-50 cursor-pointer">
