...
const MODEL_CONFIG: Record<string, ModelConfig> = {
  "/":           { file: "Heart.glb",     scale: 4.0, position: [0, 0.4, 0],  rotation: [0, 0, 0] },
  ...
  "/milestones": { file: "Dingus.glb",    scale: 3.0, position: [0, 0.2, 0],  rotation: [0, 0, 0] },
  "/memories":   { file: "Polaroids.glb", scale: 3.5, position: [0, 0.4, 0],  rotation: [0, -Math.PI / 2, 0] },
};
