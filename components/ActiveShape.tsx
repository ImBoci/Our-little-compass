...
const MODEL_CONFIG: Record<string, ModelConfig> = {
  "/":           { file: "Heart.glb",     scale: 4.0,  position: [0, 0.8, 0], rotation: [0, 0, 0] },
  ...
  "/milestones": { file: "Cat2.glb",      scale: 20.0, position: [0, 0.5, 0], rotation: [0, Math.PI, 0] },
  "/memories":   { file: "Polaroids.glb", scale: 3.5,  position: [0, 0.8, 0], rotation: [Math.PI / 2, Math.PI / 2, 0] },
};
