...
const MODEL_CONFIG: Record<string, ModelConfig> = {
  ...
  "/milestones": { file: "Dingus.glb",    scale: 0.6, position: [0, -1.5, 0], rotation: [Math.PI / 4, 0, 0] },
  "/memories":   { file: "Polaroids.glb", scale: 3.5, position: [0, -0.5, 0],  rotation: [0, -Math.PI / 2, 0] },
};
